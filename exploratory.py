...
class DataCleaner:
    ...
    def find_winners(self, dataframe):
        ...
        Args:
            ...
            generated by a data cleaning function.

        Returns:
            Results(List of strings): A list of results for each game in
            the database. Values are 'Home_Team_Win', 'Away_Team_Win', or
            'Draw'.

            Winners(List of strings): A list containing the names of each
            winning team for each game in the database. Value is None if
            the game was a draw.

            Losers(List of strings): A list containing the names of each
            losing team for each game in the database. Value is None if
            the game was a draw.
        '''
        Results = []
        Winners = []
    ...
    def find_wins_losses_draws(self, df, team):
        ...
        Returns:
            games_won(Integer): The number of games that a team won in
            one season.
            games_lost(Integer): The number of games that a team lost in
            one season.
            games_drawn(Integer): The number of games that a team drew in
            one season.
        '''
    ...
    def find_most_wins(self, df):
        ...
        Returns:
            team(String): The name of the team with the most wins in
            a season.
        '''
        team = df['Winners'].value_counts().to_frame().iloc[0].name
        return team
    ...
    def find_win_percentage(self, wins, losses, draws):
        ...
        Returns:
            wp(float): A team's win percentage.
        '''
        wp = wins / (wins + losses + draws)
        return wp
    ...
    def win_percentage_over_time(self, league, years):
        ...
        Args:
            ...
            each season that the function is to read the data of.
        Returns:
            df_wp(pd.DataFrame): A DataFrame containing years, and win
            percentages of a team for a number of seasons.
        '''
        list_of_wins = []
        for year in years:
            df = self.clean_data(league, year)
    ...
    def calculate_league_table(self, league, year):
        ...
        Returns:
            league_table(pd.DataFrame): A DataFrame representing the league
            table of one year in one league of football.
        '''
        df = self.clean_data(league, year)
        ...
        league_table = pd.DataFrame(league_table).sort_values(
    ...
    def add_losing_streak(self, league, years):
        ...
        Returns:
            df(pd.DataFrame): The dataframe of football matches
            generated by a data cleaning function.s
        '''
    ...
    def clean_match_info(self, match_info_csv):
        ...
        Returns:
            match_info(pd.DataFrame): The dataframe of supplementary
            information on football matches generated by cleaning
            match_info.csv.
        '''
...
class WebScraper:
    ...
    def scrape_league_links(self, league, year, url_ext=''):
        ...
        Args:
            ...
            rather than playoffs or pre-season matches.

        Returns:
            match_links(List of strings): A list of urls for football
            matches.
        '''
        match_links = []
    ...
    def scrape_all_leagues(self, leagues_and_exts, year):
        ...
        Returns:
            links(List of strings): A list of urls for football
            matches.
        '''
        links = []
    ...
    def scrape_page_info(self, url, league, year, round):
        ...
        Returns:
            data(pd.DataFrame): A dataframe containing information about
            football matches. Contains the name of the home team, away team,
            result, link, season, year, Elo ratings, card statistics, and
            referee name.
        '''
        html = requests.get(url).text
        page = BeautifulSoup(html, 'html.parser')
    ...
    def scrape_league_data(self, league, year, url_ext=''):
        ...
        Returns:
            dfs(pd.Dataframe): A concatenation of dataframes for matches in a
            single season.
        '''
...
def teams_in_league(leagues, league_name):
    ...
    Returns:
        teams['Teams'](Integer): The number of teams in a league.
    '''
    teams = next(
...
def return_number(string):
    ...
    Returns:
        Integer: A number isolated from a string.
    '''
...
def clean_ref(string):
    ...
    Returns:
        string(String): The name of a referee.
    '''
...
def clean_date(string):
    ...
    Returns:
        date(datetime.date or None): A datetime object pertaining to the
        date a match was played or None if the string cannot be decoded.
    '''
    try:
...
def change_date(string):
    ...
    Returns:
        datetime.date: A datetime object created from the string.
    '''
...
def team_table(df, team):
    ...
    Returns:
        df(pd.DateFrame): A dataframe of one team's matches played
        in a season.
    '''
